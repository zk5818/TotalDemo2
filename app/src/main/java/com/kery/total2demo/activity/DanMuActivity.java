...
//        File video = new File(Environment.getExternalStorageDirectory() + "/Ppp.mp4");
//        if (video.exists()) {
...
//        }
//
        videoView.setVideoPath(Environment.getExternalStorageDirectory() + "/Ppp.mp4");//videoView.setVideoPath("/mnt/sdcard/Ppp.mp4");
        videoView.start();
