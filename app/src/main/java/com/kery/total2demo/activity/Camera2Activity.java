...
import com.kery.total2demo.wight.KeryCameraView;
...
public class Camera2Activity extends AppCompatActivity {
    ...
    private int myViewPaddingLeft = 500, //MyView左右距离屏幕的距离（意思是MyView左右两边一共空了500）
            myViewPaddingTop = 300;//MyView上下距离屏幕的距离（意思是MyView上下两边一共空了500）
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myView = (KeryCameraView) findViewById(R.id.myView);
    ...
    public Bitmap ImageCrop(Bitmap bitmap) {
        ...
        int h = bitmap.getHeight(); //剪切的初始xy位置，原点位置 都是根据比例来算的
        int x = (int) ((w * (myViewPaddingLeft / 2)) / screenWidth);
        int y = (int) (h * (myViewPaddingTop / 2) / screenHeight); //剪切的宽和高
